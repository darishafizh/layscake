...
<body>
  ...
  <aside class="sidebar-nav-wrapper">
    <div class="navbar-logo">
      <a href="/Layscake">
        <h1 class="brand accent">Lay's Cake</h1>
      </a>
    </div>
          ...
          <div class="col-lg-5 col-md-5 col-6">
            <div class="header-left d-flex align-items-center">
              <div class="menu-toggle-btn mr-15">
                <button id="menu-toggle" class="main-btn btn-hover btn-accent">
              ...
              <div class="profile-box ml-15">
                <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile" data-bs-toggle="dropdown" aria-expanded="false">
                  <div class="profile-info">
                    <div class="info">
                      <div class="image">
                        <img src="{{ asset('/theme/assets/images/profile/profile-image.png') }}" alt="" />
                      </div>
                      <div>
                        <h6 class="fw-500">Lay's cake</h6>
                        <p>Admin</p>
                      </div>
                    </div>
                  </div>
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                  <li>
                    <a href="/viewProfile" class="logout"> <i class="lni lni-exit"></i> Profile </a>
                  </li>
                  <li>
                    <a href="/logout" class="logout"> <i class="lni lni-exit"></i> Logout </a>
                  </li>
                </ul>
              </div>
              <!-- profile end -->
