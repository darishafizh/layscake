              ...
              <div class="auth-cover-wrapper bg-primary-100">
                <div class="auth-cover">
                  <div class="title text-center">
                    ...
                    <p class="text-medium">Login menggunakan akun anda untuk melanjutkan</p>
                  </div>
              ...
              <div class="signin-wrapper">
                <div class="form-wrapper">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        <div class="button-group d-flex justify-content-center flex-wrap">
                          <input type="submit" class="main-btn primary-btn btn-hover w-100 text-center" value="Login">
                        </div>
                      </div>
                    </div>
                    <!-- end row -->
                  ...
                  {{-- <div class="utton-group d-flex justify-content-center flex-wrap mt-1">
                    <a href="/regist" class="main-btn light-btn btn-hover w-100 text-center text-primary">Register</a>
                  </div> --}}
                </div>
                  </p>
              </div>
            ...
            <div class="col-md-6 order-last order-md-first">
              <div class="copyright text-center text-md-start">
                <p class="text-sm">
                  ...
                  <a href="/ScheduLogic     " rel="nofollow" target="_blank"> ScheduLogic </a>
                </p>
              </div>
            </div>
            <!-- end col-->
